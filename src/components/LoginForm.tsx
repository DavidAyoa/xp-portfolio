    ...
    <div className="flex items-center">
      <div className="absolute md:w-7/12 w-screen flex flex-col gap-3">
        <div
          ...
          className={`h-24 w-full rounded-xl flex items-center py-3 px-6 cursor-pointer transition-all duration-200 ${
            hoveredProfile === 'guest' ? 'bg-color-login-blue stroke-white-1' : ''
          }`}
        >
